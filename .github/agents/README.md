...
| [`@publish-manager`](publish-manager.agent.md) | Orchestrates a portfolio publish: local validation, branch, commit, push, PR, and check-watching. Runs `scripts/preview-pr.ps1` after green checks and refuses to recommend merge until the user signs off on the rendered preview. Canonical agent for routine page edits in your working tree. | Yes |
