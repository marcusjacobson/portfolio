...
|--------|---------|-------------------|
| [`/triage-issue`](triage-issue.prompt.md) | Triage one GitHub issue: classify, label, link to a board, set priority, and post any clarifying questions as a comment. | Hand off to [`@issue-resolver`](../agents/issue-resolver.agent.md) once the issue is ready. |
